...
export default function ProductItem({ item }) {
  ...
  function handleDelelteProduct(item) {
    let url = `https://my-json-server.typicode.com/rishuranjan21/data/products/${item.id}`;
  ...
  return (
    //   container
    <div className="d-flex container-sm  px-1 py-4 mt-5 flex-column flex-lg-row gap-3" style={{backgroundColor:"#E9EEF6" , boxShadow: "0px 3px 25px #A5A5A5"}}>
      {/* left section  */}
      <ToastContainer />
      ...
      <div className="align-self-end d-flex align-items-center gap-4 flex-lg-grow-1 p-1">
        ...
        {item.edit ? (
          <>
            <span>
              <img
                src="https://cdn-icons-png.flaticon.com/128/1634/1634119.png?ga=GA1.1.209717024.1687589294"
                alt="error"
                width={"30rem"}
            ...
            <span>
              <img
                src="https://cdn-icons-png.flaticon.com/128/2177/2177697.png?ga=GA1.1.209717024.1687589294"
                alt="error"
                width={"30rem"}
                style={{ cursor: "pointer" }}
