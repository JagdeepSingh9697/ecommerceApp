...
function App() {
  ...
  //URL for fetching products data
  const url = "https://my-json-server.typicode.com/JagdeepSingh9697/data/db";

  const dispatch = useDispatch();

  //side effect hook for fetching all the products data once
  useEffect(() => {
